          ...
          <Widget>[
            RaisedButton(
                ...
                onPressed: () {
                  ...
                  FlutterBoost.singleton.open("native", exts: {'animated': '1'}).then((Map value) {
                    print(
              ...
              RaisedButton(
                ...
                onPressed: () {
                  print("open FF page!");
                  FlutterBoost.singleton.open("firstFirst", exts: {'animated': '1'}).then((Map value) {
                    print(
              ...
              RaisedButton(
                ...
                onPressed: () {
                  ...
                  FlutterBoost.singleton.open("second", exts: {'animated': '1'}).then((Map value) {
                    print(
              ...
              RaisedButton(
                  ...
                  onPressed: () {
                    ...
                    FlutterBoost.singleton.open("secondStateful",urlParams:{"present":true}).then((Map value) {
                      print(
